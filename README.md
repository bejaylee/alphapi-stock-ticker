...
| **B** | 深证成指 · 科创50 |
| **C** | 韩国综合（KOSPI） · 日经225 |
| **D** | 费城半导体(SOX) · 纳斯达克(IXIC) |

每页显示两个指数：名称（黄）+ 现价 + 涨跌幅（红涨绿跌），右上角为北京时间。
- A股/韩国/日本：休盘时显示"休盘"字样，盘中显示实时价格和涨跌幅
- 美股：显示"盘前/盘中/盘后"时段标记 + 实时价格（盘前盘后行情也显示）

## 📊 数据源

- **腾讯行情** 接口：A股（上证/创业板/深证成指/科创50）+ 美股（费城半导体SOXX、纳斯达克IXIC），返回含交易状态码，用于判断盘中/休盘
...
| 市场 | 盘中时段（北京时间） | 休盘行为 |
|------|---------------------|----------|
| A股 | 9:30-11:30, 13:00-15:00 | 显示"休盘"，30秒探测一次 |
| 韩国 | 9:00-15:30 | 同上 |
| 日本 | 9:00-11:30, 12:30-15:00 | 同上 |
| 美股 | 盘前21:00~ / 盘中~4:00 / 盘后~8:00 | 显示"休盘"，30秒探测一次 |
